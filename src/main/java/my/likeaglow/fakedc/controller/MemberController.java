...
//      return new ModelAndView("redirect:/error");
    ...
    setLoginMember(new LoginMemberDTO(updatedVO.getMEM_ID(), updatedVO.getMEM_NAME()));
  ...
  public ModelAndView leave() {
    ...
    LoginMemberDTO loginMemberDTO = getLoginMember();
   ...
   */
  @PostMapping("/leave")
  public String leaveProcess(LeaveDTO leaveDTO) {
